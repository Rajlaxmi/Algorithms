...
bool identical(node* root, node* root2)
{
	...
	else
	{
		if(root->data == root2->data)
			return (true && identical(root->left, root2->left) && identical(root->right, root2->right));
		else
			return false;
	}
}
...
int main()
{
	...
	curr2 = insert(root2, 5);
	curr2 = insert(curr2->left, 3);
	curr2 = insert(curr2->left, 1);
	curr2 = insert(curr2->left, 0);
	
	curr2 = insert((root2->left)->right, 4);
	curr2 = insert(((root2->left)->left)->right, 2);
	
	curr2 = insert(root2->right, 6);
